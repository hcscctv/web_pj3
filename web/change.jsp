    ...
    <ul id="nav" name="nav">
        ...
        <li id="account">
            ...
            <ul id="dropdown">
                ...
                <li>
                    <a href="login.jsp"><img src="img/login.png" alt="">Log in</a>
                </li>
                <li>
...
<%
travelimage image=(travelimage)request.getAttribute("img");
%>
    <div id="main">
        <form action="changedetailServlet" method="post" enctype="multipart/form-data" id="form" onsubmit="return check_submit()">
            <div id="title">Upload</div>
            <div>
                <img id="img0" src="img/travel-images/medium/<%=image.getPATH()%>">
        ...
        <script src="src/js/upload.js">
            ...
            <label>图片标题：</label>
            <input type="text" class="detail_input" value="<%=image.getTitle()%>" name="title" required>
            <input type="hidden" name="imgid" value="<%=image.getImageID()%>">
            <br> <label>图片描述：</label>
            <textarea name="detail" id="detail" cols="30" rows="3" class="detail_input" required><%=image.getDescription()%></textarea>

            <label>图片主题：</label>
            <input type="text" class="detail_input" name="content" value="<%=image.getContent()%>" id="content" required>
            <br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#160;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <select class="area-select" id="country" name="country">
                    <option value="<%=image.country()%>"><%=image.country()%></option>
